...
const METHOD1_STEPS = [
  ...
  'Find Educational Speaker',
  'Tap Book',
];

const METHOD2_STEPS = [
  'Open the Home page',
  'Tap the Educational Speaker tab',
...
const AFTER_CHIPS: { label: string; tone: 'green' | 'blue' }[] = [
  ...
  { label: 'Educational Corner unlocked', tone: 'blue' },
];

const WITHDRAW_STEPS = [
  'Go to the Mine section',
  'Open Educational Speaker',
  'Tap Withdraw',
];
...
const TITLE_CARDS: { emoji: string; body: string }[] = [
  { emoji: '👥', body: 'Visible to all club members' },
  { emoji: '📋', body: 'Automatically appears in the Meeting Agenda' },
  { emoji: '🎯', body: 'Helps members understand the learning focus' },
  { emoji: '✨', body: 'Creates a more engaging, better-prepared meeting' },
];

const FAQS: { q: string; a: string }[] = [
  {
    q: 'How do I book the Educational Speaker role?',
    a: 'You can book it in two ways: via Meeting → Open Meeting → Book a Role, or from the Educational Speaker tab on the Home page.',
  },
  {
  ...
  },
  {
    ...
    a: 'The role is reserved for you, appears under Mine, is visible as Taken to other members, and unlocks access to the Educational Corner.',
  },
  {
    q: 'What is Educational Corner?',
    a: 'Educational Corner is a dedicated workspace for the Educational Speaker to manage meeting responsibilities, especially updating the Educational Speech Title. It is opened via the blue arrow button that appears next to the role after booking.',
  },
  {
    q: 'What is the first responsibility of the Educational Speaker?',
    a: 'The first responsibility is to update the Educational Speech Title inside the Educational Corner, as early as possible after booking.',
  },
  {
    q: 'Why is the Educational Speech Title important?',
    a: 'The title helps members understand the purpose of the educational session, automatically appears in the Meeting Agenda, aligns members with the session focus, and creates a more engaging learning experience.',
  },
  {
    q: 'Who can update the Educational Speech Title?',
    a: 'Only the Educational Speaker (who booked the role) and the Vice President Education (VPE) can update the Educational Speech Title.',
  },
  {
    q: 'Where can I find the Educational Corner?',
    a: 'A blue arrow button appears next to the Educational Speaker role after booking. Tapping it opens the Educational Corner.',
  },
  {
    q: 'Can the VPE update the title if the Educational Speaker has not?',
    a: 'Yes. The VPE can access the Educational Corner and update the Educational Speech Title so meeting preparation continues smoothly.',
  },
  {
    q: 'Can more than one person book the Educational Speaker role?',
    a: 'No. Only one member can reserve the Educational Speaker role for a given meeting.',
  },
];
...
export default function T360TrainingEducationalSpeakerRoleScreen() {
      ...
      >
        <View style={styles.card}>
          ...
          <Text style={styles.lead} maxFontSizeMultiplier={1.3}>
            How to book, manage, and fulfil the Educational Speaker role — from reserving your spot to updating the
            Educational Speech Title.
          </Text>

          <Text style={styles.sectionHeading} maxFontSizeMultiplier={1.3}>
            How to book the Educational Speaker role
          </Text>
          <Text style={styles.body} maxFontSizeMultiplier={1.25}>
            You can book the Educational Speaker role in <Text style={styles.inlineBold}>two ways</Text>:
          </Text>
          ...
          <View style={styles.methodCard}>
            ...
            <View style={styles.calloutFast}>
              <Text style={styles.calloutFastText} maxFontSizeMultiplier={1.2}>
                Faster — no need to navigate to the full role booking page.
              </Text>
            </View>
          </View>
          ...
          <Text style={styles.body} maxFontSizeMultiplier={1.25}>
            Once you book the Educational Speaker role, it is immediately reserved for you:
          </Text>
          ...
          <Text style={styles.body} maxFontSizeMultiplier={1.25}>
            Changed your mind? You can withdraw at any time before the meeting.
          </Text>
          ...
          <View style={styles.cornerBox}>
            ...
            <Text style={styles.cornerBody} maxFontSizeMultiplier={1.25}>
              ...
              Educational Speaker role. Tapping it opens the <Text style={styles.inlineBold}>Educational Corner</Text> —
              a dedicated workspace created specifically to help you manage your meeting responsibilities.
            </Text>
            <Text style={[styles.cornerBody, { marginTop: 12 }]} maxFontSizeMultiplier={1.25}>
              The first and most important responsibility inside the Educational Corner is to update the{' '}
              <Text style={styles.inlineBold}>Educational Speech Title</Text>. It is recommended to do this{' '}
              <Text style={styles.inlineBold}>as early as possible</Text> after booking the role.
            </Text>
          </View>
          ...
          <Text style={styles.body} maxFontSizeMultiplier={1.25}>
            The title helps members understand the educational session and sets expectations for the learning experience.
          </Text>
          <View style={styles.themeGrid}>
            {TITLE_CARDS.map(({ emoji, body }) => (
          ...
          <Text style={styles.sectionHeading} maxFontSizeMultiplier={1.3}>
            Who can update the speech title?
          </Text>
          <Text style={styles.body} maxFontSizeMultiplier={1.25}>
            Only two roles have permission to update the Educational Speech Title:
          </Text>
          <View style={styles.whoGrid}>
            ...
            <View style={styles.whoCard}>
              ...
              <View style={styles.whoTextCol}>
                ...
                <Text style={styles.whoSpan} maxFontSizeMultiplier={1.15}>
                  Can access Educational Corner and update the title when support is needed.
                </Text>
              </View>
            </View>
          </View>
